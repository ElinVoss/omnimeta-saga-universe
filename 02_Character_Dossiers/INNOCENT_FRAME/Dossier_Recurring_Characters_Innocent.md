...
**Arc**: Introduced (N15), spreads doctrine (N16–N25), final offer to Jhace (N28)  
**Death**: N28 Ch.10 — Chooses self-release; demonstrates doctrine; dies peacefully  

**Voice**: Soft, accepting. "All things end. Why resist? Let go."

**Function**: Represents Entropy faction; shows acceptance as nihilism

---

## 3. CIVIC AUTHORITIES & ANTAGONISTS

### Inspector Harven (Sanitist Authority, N1–N11)

**Age**: 51 years (N1)  
**Role**: Senior Sanitist inspector; attempts to suppress Soulpulse use  
**Background**: Career enforcer; believes magic is dangerous  
...
**Function**: Represents institutional opposition; shows law vs. survival conflict

---

### Councilor Vren (Civic Authority, N2–N16)

**Age**: 59 years (N2)  
**Role**: Grindheim civic councilor; controls permits and resources  
**Background**: Career politician; prioritizes stability over justice  

**Personality**: Pragmatic, corrupt, survival-focused  
**Skills**: Political maneuvering; resource allocation; bureaucratic obstruction  
**Arc**: Antagonist (N2–N10), attempts to control Jhace (N6–N12), forced alliance (N13–N16)  
**Death**: N16 Ch.7 — Assassinated by Mobel faction; purged as "corrupt"  

**Voice**: Political, evasive. "Resources are limited. Priorities must be established. I'm sure you understand."

**Function**: Represents political corruption; shows institutional failure

---

## 4. CIVILIAN ANCHORS & WITNESSES

### Petran Family (Civilian Survivors, N1–N19)

**Members**: Father (Petran, 44), Mother (Sielle, 41), Daughter (Miri, 12)  
**Role**: Civilian family Jhace repeatedly saves; represents stakes  
...
**Function**: Humanizes stakes; shows civilian perspective; represents who Jhace fights for

---

### Old Torven (Witness, N1–N23)

**Age**: 73 years (N1)  
**Role**: Elderly craftsman; witnesses entire saga; provides historical context  
...
**Function**: Provides historical perspective; shows pre-Piercing world; witnesses transformation

---

## 5. DEFECTORS & CONVERTS

### Selwin (Corlexi Defector, N17–N30)

**Age**: 29 years (N17)  
**Role**: Former Xilcore follower; defects to resistance  
**Background**: Architect who realized perfection is tyranny  

**Personality**: Guilt-ridden, determined, precise  
**Skills**: Form-pattern mastery; geometric analysis; strategic planning  
**Arc**: Defects (N17), proves loyalty (N18–N20), becomes trusted advisor (N21–N30)  
**Status**: Survives through N30  

**Voice**: Precise, guilty. "I helped build their fortresses. I know how to break them."

**Function**: Shows defection is possible; provides insider knowledge; represents redemption

---

### Mourne (Eries Defector, N12–N25)

**Age**: 42 years (N12)  
**Role**: Former Seeri follower; defects after witnessing mass death  
**Background**: Philosopher who realized release is murder  

**Personality**: Melancholic, determined, haunted  
**Skills**: Entropy-pattern knowledge; philosophical insight; strategic thinking  
**Arc**: Defects (N12), provides testimony (N12 Ch.5), joins resistance (N13–N25)  
**Death**: N25 Ch.9 — Dies defending civilians; chooses fight over release  

**Voice**: Soft, haunted. "I watched them die. They called it mercy. It was murder."

**Function**: Integrates Interlude 2B into A-plot; shows Entropy doctrine consequences
...
**Scaffold Workers** (N1): Colleagues Jhace works with pre-Piercing  
**Heat Grid Technicians** (N2): Specialists Jhace coordinates with  
**Poisoning Victims** (N3): Civilians Jhace attempts to save; several die  
**Refugee Families** (N4–N5): Civilians fleeing Piercing aftermath  

### CRACK (N6–N10)

**Apprentice Collective** (N6–N10): Students Jhace trains; various names and backgrounds  
**God-Vessel Witnesses** (N6): Civilians who witness transformations  
**Faction Refugees** (N7–N10): People fleeing god-vessel territories  

### FORGE (N11–N15)

**Resistance Recruits** (N11–N15): New members joining Jhace's network  
**Faction Enforcers** (N11–N15): God-vessel lieutenants and soldiers  
**Civilian Casualties** (N11–N15): Named victims of faction wars  

### SMELT (N16–N20)

**Siege Survivors** (N16–N20): Civilians trapped in conflict zones  
**Defectors** (N16–N20): Faction members who switch sides  
**Medic Corps** (N16–N20): Healers trained by Rennik  

### CLEAR (N21–N25)

**Corridor Defenders** (N21–N25): Resistance members holding positions  
**Faction Zealots** (N21–N25): True believers escalating violence  
**Final Witnesses** (N21–N25): Civilians documenting events  

### BREAK (N26–N30)

**Stasis Witnesses** (N26–N30): People who witness Jhace's fivefold stasis  
**Final Survivors** (N26–N30): Last resistance members standing  
**Tiffani** (N30): Returns; reveals orchestration; universe ends  
...
- **Recurring character profiles** for resistance members, faction lieutenants, civic authorities
- **Civilian anchors** who humanize stakes across multiple novellas
- **Defector arcs** showing conversion from faction to resistance
- **Minor characters** organized by Turning for easy reference

### Character Continuity

When a character appears in multiple novellas:
- Reference their prior appearances
- Show accumulating costs (scars, exhaustion, trauma)
- Track relationship evolution with Jhace
- Honor their death when it occurs (no resurrections in innocent frame)

### Innocence Protocol Reminder

All recurring characters experience:
- Crises as organic, not orchestrated
- God-vessels as emergent forces, not engineered
- Tiffani as dead (N6–N29), not secretly alive
- Jhace's power as survival tool, not weapon-forging

**No foreshadowing of guilty canon. Maintain innocence in all character perspectives.**
...
**File Location**: `omnimeta-saga-universe/02_Character_Dossiers/INNOCENT_FRAME/Dossier_Recurring_Characters_Innocent.md`  
**Cross-Reference**: All N1–N30 Prose Engine prompts must reference this file for recurring character consistency and continuity tracking.

---

## COMPLETE INNOCENT-FRAME CHARACTER DOSSIER SET

This completes the five innocent-frame character dossiers:

1. ✅ **Dossier_Jhace_Torrins_Innocent.md** (~25,000 characters)
2. ✅ **Dossier_Tiffani_Merrow_Innocent.md** (~22,000 characters)
3. ✅ **Dossier_Crew_Secondary_Innocent.md** (~18,000 characters)
4. ✅ **Dossier_God_Vessels_Innocent.md** (~17,000 characters)
5. ✅ **Dossier_Recurring_Characters_Innocent.md** (~13,000 characters)

**Total: ~95,000 characters of innocent-frame character documentation**

All files maintain strict innocence protocol. Zero orchestration awareness. Zero guilty canon reveals. Ready for Writer GPT consumption.
