# [PLACEHOLDER] N18 STORY BIBLE — EMBERED DEFECTORS

**Turning**: SMELT  
**Position in Turning**: 3 of 5  
**Status**: PLACEHOLDER — Bible not yet generated  
**Generate When**: Ready to develop N18 prose

---

## GENERATION INSTRUCTIONS FOR OMNIMETA SPACE

When you encounter this placeholder, you are being asked to generate the complete Story Bible for **N18: Grinding Wars**.
...
### Structural Timelines (Query for N18 Section)

- [01_Progression_Timeline_Master.md](https://raw.githubusercontent.com/ElinVoss/omnimeta-saga-universe/main/03_Structural_Timelines/01_Progression_Timeline_Master.md) — **Read N18 section**
...
- [03_Character_Arc_Tracker.md](https://raw.githubusercontent.com/ElinVoss/omnimeta-saga-universe/main/03_Structural_Timelines/03_Character_Arc_Tracker.md) — **Read Jhace N18 arc**
- [04_Crisis_Escalation_Map.md](https://raw.githubusercontent.com/ElinVoss/omnimeta-saga-universe/main/03_Structural_Timelines/04_Crisis_Escalation_Map.md) — **Read N18 crisis**
- [05_Soulpulse_Capacity_Progression.md](https://raw.githubusercontent.com/ElinVoss/omnimeta-saga-universe/main/03_Structural_Timelines/05_Soulpulse_Capacity_Progression.md) — **Read N18 capacity**
- [06_Relationship_Evolution_Timeline.md](https://raw.githubusercontent.com/ElinVoss/omnimeta-saga-universe/main/03_Structural_Timelines/06_Relationship_Evolution_Timeline.md) — **Read N18 relationships**
- [07_God_Vessel_Faction_Timeline.md](https://raw.githubusercontent.com/ElinVoss/omnimeta-saga-universe/main/03_Structural_Timelines/07_God_Vessel_Faction_Timeline.md) — **Read N18 god-vessel activities**
...
**Major events that MUST occur in N18:**
Corridor wars intensify, Torim dies holding position, stalemate emerging

**Deaths this novella:** Torim
...
[Query previous Bible (N17) for character states at end]

### Character Transformations This Novella

[Query timeline for N18 character arcs]

### Crisis Escalation

[Query crisis escalation map for N18]

### Soulpulse Developments

[Query capacity progression for N18]

### World State Changes

[Query timeline for N18 world state]

### Continuity Constraints (IMMUTABLE)

[Query all previous Bibles (N01-N17) for locked facts]

### Interlude Requirements

[Query interlude placement logic for N18]

### Beat Method Constraints

[Query beat unpredictability system, avoid consecutive repeats from N17]
...
3. **Worldframe** (Te'Oga state at N18)
4. **Cast** (Character profiles with innocent motives only)
5. **Magic & Limits** (Soulpulse status at N18)
...
13. **Mission Statement** (What N18 accomplishes in the saga)
...
1. **Save the completed Bible as**: `N18_Bible_Embered_Defectors.md`
2. **Place in repository at**: `04_Writer_Deliverables/02_Bibles/`
3. **Commit message**: `Add N18 Story Bible: Embered Defectors`
...
git add 04_Writer_Deliverables/02_Bibles/N18_Bible_Grinding_Wars.md
git commit -m "Add N18 Story Bible: Grinding Wars"
...
- [ ] All previous Bibles (N01-N17) read and continuity maintained
...
**File Location**: `omnimeta-saga-universe/04_Writer_Deliverables/02_Bibles/N18_Bible_PLACEHOLDER.md`  
**Status**: Awaiting generation  
**Next Step**: Generate complete N18 Bible following these instructions
