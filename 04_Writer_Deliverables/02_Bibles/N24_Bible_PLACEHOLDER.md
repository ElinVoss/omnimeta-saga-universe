...
**Generate When**: Ready to develop N24 prose

---

## GENERATION INSTRUCTIONS FOR OMNIMETA SPACE

When you encounter this placeholder, you are being asked to generate the complete Story Bible for **N24: Purge and Resistance**.
...
### Structural Timelines (Query for N24 Section)

- [01_Progression_Timeline_Master.md](https://raw.githubusercontent.com/ElinVoss/omnimeta-saga-universe/main/03_Structural_Timelines/01_Progression_Timeline_Master.md) — **Read N24 section**
...
- [03_Character_Arc_Tracker.md](https://raw.githubusercontent.com/ElinVoss/omnimeta-saga-universe/main/03_Structural_Timelines/03_Character_Arc_Tracker.md) — **Read Jhace N24 arc**
- [04_Crisis_Escalation_Map.md](https://raw.githubusercontent.com/ElinVoss/omnimeta-saga-universe/main/03_Structural_Timelines/04_Crisis_Escalation_Map.md) — **Read N24 crisis**
- [05_Soulpulse_Capacity_Progression.md](https://raw.githubusercontent.com/ElinVoss/omnimeta-saga-universe/main/03_Structural_Timelines/05_Soulpulse_Capacity_Progression.md) — **Read N24 capacity**
- [06_Relationship_Evolution_Timeline.md](https://raw.githubusercontent.com/ElinVoss/omnimeta-saga-universe/main/03_Structural_Timelines/06_Relationship_Evolution_Timeline.md) — **Read N24 relationships**
- [07_God_Vessel_Faction_Timeline.md](https://raw.githubusercontent.com/ElinVoss/omnimeta-saga-universe/main/03_Structural_Timelines/07_God_Vessel_Faction_Timeline.md) — **Read N24 god-vessel activities**
...
**Major events that MUST occur in N24:**
Jhace kills Lysenne in self-defense, all factions converging

**Deaths this novella:** Lysenne
...
[Query previous Bible (N23) for character states at end]

### Character Transformations This Novella

[Query timeline for N24 character arcs]

### Crisis Escalation

[Query crisis escalation map for N24]

### Soulpulse Developments

[Query capacity progression for N24]

### World State Changes

[Query timeline for N24 world state]

### Continuity Constraints (IMMUTABLE)

[Query all previous Bibles (N01-N23) for locked facts]

### Interlude Requirements

[Query interlude placement logic for N24]

### Beat Method Constraints

[Query beat unpredictability system, avoid consecutive repeats from N23]
...
3. **Worldframe** (Te'Oga state at N24)
4. **Cast** (Character profiles with innocent motives only)
5. **Magic & Limits** (Soulpulse status at N24)
...
13. **Mission Statement** (What N24 accomplishes in the saga)
...
git add 04_Writer_Deliverables/02_Bibles/N24_Bible_Purge_and_Resistance.md
git commit -m "Add N24 Story Bible: Purge and Resistance"
...
- [ ] All previous Bibles (N01-N23) read and continuity maintained
...
**File Location**: `omnimeta-saga-universe/04_Writer_Deliverables/02_Bibles/N24_Bible_PLACEHOLDER.md`  
**Status**: Awaiting generation  
**Next Step**: Generate complete N24 Bible following these instructions
